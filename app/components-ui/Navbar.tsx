    ...
    <>
      <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-32 backdrop-blur">
        ...
        <div className="hidden md:flex items-center gap-8">
          <Link href="/components" className={`hover:text-gray-600 dark:hover:text-slate-300 ${currentPage === 'components' ? 'text-[#539E43]' : ''}`}>
            Components
          </Link>
          <Link href="/docs" className={`hover:text-gray-600 dark:hover:text-slate-300 ${currentPage === 'docs' ? 'text-[#539E43]' : ''}`}>
            Docs
          </Link>
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={toggleTheme}
            className="p-2 rounded-lg border border-gray-300 dark:border-slate-400 hover:bg-gray-100 dark:hover:bg-white/10 transition"
          >
            {theme === "dark" ? (
          ...
          <Link href="/docs" className="border border-gray-300 dark:border-slate-400 hover:bg-gray-100 dark:hover:bg-white/10 transition rounded-lg px-6 h-11 flex items-center">
            View Docs
          </Link>
        </div>
      ...
      {menuOpen && (
        <div className="fixed inset-0 z-[100] bg-black/60 backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden">
          <Link href="/components" onClick={() => setMenuOpen(false)}>Components</Link>
          <Link href="/docs" onClick={() => setMenuOpen(false)}>Docs</Link>
          <button onClick={() => setMenuOpen(false)} className="size-10 bg-slate-100 text-black rounded-md flex items-center justify-center">
