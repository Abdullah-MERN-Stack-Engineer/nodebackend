...
export default function HeroSection({ searchQuery, setSearchQuery, handleSearch }: HeroSectionProps) {
  return (
    <div className="relative max-w-5xl mx-auto px-6 mt-20">
      ...
      <div className="text-center mb-8">
        <h1 className="text-4xl md:text-5xl lg:text-5xl font-bold mb-4 text-primary flex items-center justify-center gap-2">
          ...
          <span className="flex items-center">
            N <svg className="size-5" viewBox="0 0 256 289" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
        ...
        <p className="text-base text-secondary max-w-2xl mx-auto">
          ...
          <span className="text-accent font-medium"> Own your code, own your data.</span>
        </p>
      </div>
      ...
      <div className="flex flex-col items-center gap-4 mb-8">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          <Link href="/components" className="px-6 py-3 bg-accent hover-accent text-white rounded-lg flex items-center gap-2 transition-colors">
